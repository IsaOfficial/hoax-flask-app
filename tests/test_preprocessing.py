...
class PreprocessingTests(unittest.TestCase):
    ...
    def test_endpoint_transforms_cleaned_text_and_matches_pipeline(self):
        text = "Para pemimpin menyerang kelompok tersebut."
        expected = model_pipeline.predict_text(text)
    ...
    def test_pipeline_and_endpoint_share_preprocessor(self):
        self.assertIs(app.preprocess, preprocess)
        self.assertIs(model_pipeline.preprocess, preprocess)
